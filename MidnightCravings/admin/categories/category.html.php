      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="sidebar-sticky pt-3 side_bar_links">
          <ul class="nav flex-column">
            ...
            {
              echo "<li class='nav-item'>
              <a class='nav-link active' href=''><i class='fas fa-sitemap fa-fw' aria-hidden='true'></i>&nbsp;Categories</a></li>";
            }
            ?>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
      ...
      <div class="content">
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-stripped display m-0" id="cat_table_id">
            <thead>
              <tr>
                <th class="categories_th_data" width="80%">Categories</th>
                <th width="10%">Edit</th>
          ...
          <tbody>
            <?php foreach ($categories as $category): ?>
                ...
                <tr>
                  <td><?php html( $category['category_name'] ); ?></td>
                  <td>
                    <form action="?" method="post">
                    ...
                    <td><div class="input-group">
                      <input class="form-control btn-outline-danger delete_btn rounded-0" type="submit" name="action" value="Delete">
                    </div>
                    </td>
                  </form>
                </tr>                      
