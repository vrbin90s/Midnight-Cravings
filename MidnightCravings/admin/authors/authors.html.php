...
<body>
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
      ...
      <h1 class="content-title">Manage Authors</h1>
      ...
      <div class="content">
        <div class="table-responsive">
          <table class="table table-bordered table-stripped m-0 display" id="author_table_id">
            <thead>
              <tr>
                <th width="20%">Author Name</th>
                <th class="recipes_data" width="60%">Email Address</th>
                <th width="10%">Edit</th>
                    ...
                    <td>
                      <form action="?" method="post">
                        <div class="input-group">
                          ...
                          <input class="form-control btn-outline-dark rounded-0 outline_buttons" type="submit" name="action" value="Update">                    
                        </div>
                    </td>
                    <td>
                      <div class="input-group">
