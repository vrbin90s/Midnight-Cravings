	...
	<div class="container confirm_delete_author">
		<div class="card text-center">
			<div class="card-header py-3">
				<h3 class="card-title">Confimr Delete Author ?</h3>
			</div>
			<div class="card-body">
				...
				<form class="delete_form"  action="" method="post">
					<div class="form-group">
						...
						<div class="delete-text">Do you really want to delete:<b> <?php html($name); ?> </b> and all his recipe records from the system ? </div>
